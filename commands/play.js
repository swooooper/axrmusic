...
module.exports = {
  ...
  run: async function (client, message, args) {
   ...
   var serverQueue = message.client.queue.get(message.guild.id);
    ...
    if (!song){
      if (!online.afk) {
        sendError("The music has ended || If you like the bot stay 24/7 in voice channel run `?afk` However the bot will remain in the vc 24/7 and you can just join and play more music:", message.channel)
